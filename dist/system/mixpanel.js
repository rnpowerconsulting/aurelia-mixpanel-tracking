...
System.register(['aurelia-dependency-injection', 'aurelia-event-aggregator', 'aurelia-logging'], function (_export, _context) {
	...
	var inject, EventAggregator, LogManager, _dec, _class, defaultOptions, delegate, Mixpanel;
	...
	return {
		...
		execute: function () {
			...
			_export('Mixpanel', Mixpanel = (_dec = inject(EventAggregator), _dec(_class = function () {
